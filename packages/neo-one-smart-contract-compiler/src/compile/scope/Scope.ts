...
export interface Scope {
  ...
  addUnique(): Name;
  get(sb: ScriptBuilder, node: Node, options: VisitOptions, name: Name | string): void;
  ...
  set(sb: ScriptBuilder, node: Node, options: VisitOptions, name: Name | string): void;
  ...
  emit(sb: ScriptBuilder, node: Node, options: VisitOptions, func: (options: VisitOptions) => void): void;
}
